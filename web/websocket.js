window.onload = init;
//var socket = new WebSocket("ws://localhost:8080/WebsocketElectrodomesticos/actions");
var socket = new WebSocket("ws://"+ document.location.host + document.location.pathname +"actions");
